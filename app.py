...
def main():
    st.title("Mushroom Prognosis Web App")
    st.sidebar.title("Tunings")
    st.markdown("Are your mushrooms edible or poisonous? 🍄")
    st.sidebar.markdown("Are your mushrooms edible or poisonous? 🍄")

    @st.cache(persist=True)
    def load_data():
        data = pd.read_csv("C:\\Users\\KSHITIJ AGGARWAL\\Desktop\\Courses\\guided project\\streamlit-ml\\mushrooms.csv")
